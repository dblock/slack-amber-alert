module Api
  module Presenters
    module MissingChildPresenter
      ...
      property :name, type: String, desc: 'Missing child name.'
      property :state, type: String, desc: 'Missing child state.'
      property :status, type: String, desc: 'Missing child status.'
